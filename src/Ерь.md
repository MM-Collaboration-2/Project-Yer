...
- **type()** - возвращаес строку с названием типа объекта
...
```
не виден глазам ери. Пробелы кстати тоже не видны, если они не в строке (стринг).
...
Нашли баг, есть вопросы или предложения? Пишите *@mrrbyb*
